...
public class prob12b {
	...
	public static boolean usedTwice = false;
	public static String locationUsedTwice ="";
	...
	public static ArrayList<String> getPaths(ArrayList<String> lines, String curLocation, String curPath, int depth) {
		...
		for(int i=0; i<lines.size(); i++) {
			...
			if(dest.equals(dest.toLowerCase())) {
				...
				if(locationsTaken.contains(dest) && usedTwice) {
					continue;
				} else if(locationsTaken.contains(dest) && usedTwice == false) {
					usedTwice = true;
					locationUsedTwice = dest;
				} else {
			...
			if(locationsTaken.contains(dest)) {
				...
				if(usedTwice && locationUsedTwice.equals(dest)) {
					usedTwice = false;
					locationUsedTwice = "";
				} else {
