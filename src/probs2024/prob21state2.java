...
public class prob21state2 {
	...
	prob21state2(int robotsLocationsIn[][], String curInput, String curOutput, boolean badState) {
	...
	public prob21state2 makeMove(int move) {
