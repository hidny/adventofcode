...
public class prob23Diff {
	...
	public static ArrayList<prob23SegmentDiff> segments;
		...
		while(currentIndex <= endIndex) {
			...
			if(current.isSplitsOnInput()) {
				...
				if(lines.get(current.getStartIndex()).startsWith("tgl")) {
					...
					dealWithAmbiguousTglWithInput(lines, currentIndex, input);
					
				} else if(lines.get(current.getStartIndex()).startsWith("jnz")) {
					//System.out.println("Jump time");
					int exitIndex = dealWithAmbiguousJnzWithInput(lines, currentIndex, input);
	...
	public static prob23SegmentDiff getSegmentEffects(ArrayList<String> lines, prob23SegmentDiff segment) {
	...
	public static void dealWithAmbiguousTglWithInput(ArrayList<String> lines, int programCounter, long input[]) {
		...
		public static int dealWithAmbiguousJnzWithInput(ArrayList<String> lines, int programCounter, long input[]) {
