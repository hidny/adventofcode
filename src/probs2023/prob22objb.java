...
public class prob22objb {
	...
	ArrayList<Integer> blocksCanDisintegrate = new ArrayList<Integer>();
	
	
	
	public static ArrayList<prob22objb> sort(ArrayList<prob22objb> bricks) {
	...
	public static boolean intersects(prob22objb a, prob22objb b) {
