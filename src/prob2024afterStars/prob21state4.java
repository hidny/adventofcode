...
public class prob21state4 {
	...
	prob21state4(int robotsLocationsIn[][], String curInput, String outputByDepthIn[], String curOutput, boolean badState) {
	...
	public prob21state4 makeMove(int move) {
		
		if(this.badState) {
			return null;
		}
		
		prob21state4 newState = new prob21state4(robotsLocations, this.curInput + prob21clean2.nextChar[move], this.outputByDepth, this.curOutput, this.badState);
	...
	public prob21state4 makeMove(prob21state4 newState, int move, int index) {
